...
CREATE TABLE IF NOT EXISTS "SAS_ETABLISSEMENT" (
	...
	"cerfa"	TEXT,
	"prixMin"	TEXT,
	"coordinates__id"	TEXT,
	"coordinates_title"	TEXT,
	"coordinates_isPublished"	TEXT,
	"coordinates_createdAt"	TEXT,
	"coordinates_updatedAt"	TEXT,
	"coordinates_street"	TEXT,
	"coordinates_postcode"	TEXT,
	"coordinates_deptcode"	TEXT,
	"coordinates_deptname"	TEXT,
	"coordinates_city"	TEXT,
	"coordinates_phone"	TEXT,
	"coordinates_emailContact"	TEXT,
	"coordinates_gestionnaire"	TEXT,
	"coordinates_website"	TEXT,
	"coordinates_latitude"	TEXT,
	"coordinates_longitude"	TEXT,
	"ehpadPrice__id"	TEXT,
	"ehpadPrice_updatedAt"	TEXT,
	"ehpadPrice_prixHebPermCs"	TEXT,
	"ehpadPrice_prixHebPermCd"	TEXT,
	"ehpadPrice_prixHebPermCsa"	TEXT,
	"ehpadPrice_prixHebPermCda"	TEXT,
	"ehpadPrice_prixHebTempCs"	TEXT,
	"ehpadPrice_prixHebTempCd"	TEXT,
	"ehpadPrice_prixHebTempCsa"	TEXT,
	"ehpadPrice_prixHebTempCda"	TEXT,
	"ehpadPrice_tarifHebJour"	TEXT,
	...
	"raPrice__id"	TEXT,
	"raPrice_updatedAt"	TEXT,
	"raPrice_PrixF1"	TEXT,
	"raPrice_PrixF1ASH"	TEXT,
	"raPrice_PrixF1Bis"	TEXT,
	"raPrice_PrixF1BisASH"	TEXT,
	"raPrice_PrixF2"	TEXT,
	"raPrice_PrixF2ASH"	TEXT,
	"raPrice_autreTarifPrest"	TEXT,
	"raPrice_prestObligatoire"	TEXT
);
CREATE TABLE IF NOT EXISTS "SAS_INSEE_COMMUNE" (
	"TYPECOM"	TEXT,
	"COM"	TEXT,
	"REG"	TEXT,
	"DEP"	TEXT,
...
CREATE TABLE IF NOT EXISTS "SAS_INSEE_DEPARTEMENT" (
	"DEP"	TEXT,
	"REG"	TEXT,
	"CHEFLIEU"	TEXT,
	"TNCC"	TEXT,
...
CREATE TABLE IF NOT EXISTS "SAS_INSEE_REGION" (
	"REG"	TEXT,
	"CHEFLIEU"	TEXT,
	"TNCC"	TEXT,
	"NCC"	TEXT,
